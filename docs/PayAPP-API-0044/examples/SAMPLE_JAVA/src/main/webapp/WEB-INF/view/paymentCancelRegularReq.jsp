...
<div class="container">
    ...
    <form class="form-horizontal" role="form" method='post' action="paymentCancelRegularAction">
        ...
        <div class="form-group">
            <label for="mul_no" class="col-sm-2 control-label">정기결제요청번호</label>

            <div class="col-sm-10">
                <input type="number" class="form-control" id="rebill_no" name="rebill_no" placeholder="정기결제요청번호"
                       required="required">
            </div>
        </div>
